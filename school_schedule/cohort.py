# new_cohort = Cohort("Ocelots", [samara, claire])
# new_cohort.get_num_students()  # => 2
# new_cohort.add_student(sylvia)  # => [samara, claire, sylvia]
# new_cohort.get_student_summaries() 
'''
Output of line 58:
